...
export class AppComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    clientsList: client_table[];

    @ViewChild('layoutContainer', { read: false, static: false }) layourContainerViewChild: ElementRef;
    ...
    constructor(public renderer2: Renderer2, public zone: NgZone, public clientsService: ClientsService) { }

    ngOnInit() {
        this.zone.runOutsideAngular(() => { this.bindRipple(); });
        this.clientsService.GetClients().subscribe(res => this.clientsList = res);
    }
